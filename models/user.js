...
export default (sequelize, DataTypes) => {
  class User extends Model {
    static associate(models) {
      ...
      User.hasMany(models.Task, {
        as: "tasks", // "as" para uniformidad usando mayúsculas y minúsculas
        foreignKey: "userId", // Sobreescribimos el nombre de la asociación para que coincida con el nombre de la columna
      });
    }
  }
  ...
  User.beforeCreate((user, options) => {
    // Función que se ejecuta antes de insertar un registro
